...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ẞoost-by Ecr_aaM — Boost Réseaux Sociaux 24/7" },
      { property: "og:description", content: "Plateforme premium de boost Facebook & TikTok. Likes, vues, abonnés, partages. Service 24h/24, livraison rapide." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ẞoost-by Ecr_aaM — Boost Réseaux Sociaux 24/7" },
      { name: "twitter:description", content: "Plateforme premium de boost Facebook & TikTok. Likes, vues, abonnés, partages. Service 24h/24, livraison rapide." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/fc6c54ba-542c-41e8-bc2e-794da71053c8" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/fc6c54ba-542c-41e8-bc2e-794da71053c8" },
    ],
